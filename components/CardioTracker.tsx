          ...
          {isSaved ? (
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="sm:col-span-2"><label htmlFor="calories" className="flex items-center gap-2 text-sm font-medium text-gray-300 mb-1"><Flame className="w-4 h-4 text-cyan-400" />Calorías</label><input type="number" step="any" inputMode="decimal" id="calories" name="calories" value={metrics.calories} onChange={handleInputChange} placeholder="Kcal" className="w-full bg-gray-700 border border-gray-600 rounded-md py-2 px-3 focus:ring-cyan-500 focus:border-cyan-500 transition"/></div>
                </div>
                <div>
